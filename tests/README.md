...
Technical Momentum 正式数据与 Locked 前 readiness 专项：

```powershell
python -m unittest discover -s tests -p "test_technical_formal*.py" -v
python -m unittest tests.test_technical_momentum_experiment -v
```
